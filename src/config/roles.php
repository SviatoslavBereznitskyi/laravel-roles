...
return [
    ...
    */
    ...
    'teamsTable'            => env('ROLES_TEAMS_DATABASE_TABLE', 'teams'),
    'teamUserTable'         => env('ROLES_TEAM_USER_DATABASE_TABLE', 'team_user'),
    'roleUserTable'         => env('ROLES_ROLE_USER_DATABASE_TABLE', 'role_user'),
    'roleTeamTable'         => env('ROLES_ROLE_TEAM_DATABASE_TABLE', 'role_team'),
    ...
    'permissionsTeamTable'  => env('ROLES_PERMISSION_TEAM_DATABASE_TABLE', 'permission_team'),
    ...
    */
    ...
    'models' => [
        ...
        'team'          => env('ROLES_DEFAULT_TEAM_MODEL', jeremykenedy\LaravelRoles\Models\Team::class),
